...
- Live Supabase is **not certified** until Owner applies migrations, sets `STUDIO_SUPERVISION_SUPABASE_SECRET_KEY` through an approved secret path, and authorizes a real two-process proof. Do not ask Tagia to paste secrets.  
