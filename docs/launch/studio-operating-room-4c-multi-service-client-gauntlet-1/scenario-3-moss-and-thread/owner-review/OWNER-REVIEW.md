...
| # | Item | Path |
|---|------|------|
| 1 | Campaign direction | `docs/launch/studio-operating-room-4c-multi-service-client-gauntlet-1/scenario-3-moss-and-thread/deliverables/campaign-direction.md` |
