...
**Visual locks (Mobile OPEN):** Welcome = `MOBILE_VISUAL_MASTER`. Voice Choice = **OWNER ACCEPTED** 2026-08-29 (`VOICE-CHOICE-OWNER-ACCEPTED-LOCK.md`). Name question = **OWNER ACCEPTED** 2026-08-29 (`NAME-QUESTION-OWNER-ACCEPTED-LOCK.md`). System checkpoint: `MOBILE-VISUAL-SYSTEM-CHECKPOINT.md`. Do not redesign those three screens. No Supervision. No merge.  
