...
export function evaluateScenario2Acceptance(input?: {
  ...
  const disclosedLimits = [
    ...
    "No shop URL was owner-authorized; none is shown.",
    "No contact email was owner-authorized; none is shown.",
    "No phone was owner-authorized; none is shown.",
    "Box contents are the authorized product name only. Origin, weight, and tasting notes were not supplied and are not invented.",
