...
const UPDATE_EXIT_COPY: Record<UpdateExitPresentationServiceId, UpdateExitCopy> = {
  ...
  "rm-j007": {
    ...
    cardPurpose:
      "Reference-guided update: supply your existing promotion plus exact changes; The Studio recreates one updated final with bounded edits only.",
    tagline:
      "Businesses with one existing promotional item that needs current details refreshed — without buying a new concept.",
    drawerPurpose:
      "You supply your existing promotion as the reference and the exact changes. The Studio recreates one updated promotional item using that reference as direction. Bounded edits only: dates, prices, contact information, wording, and optionally one image. This is not a pixel-perfect edit of your original file and not a redesign.",
    deliverables: [
      "One recreated updated promotional item guided by your supplied reference",
      "Bounded updates: dates, prices, contact information, wording, or one approved image",
      "Export of the updated final file",
      "Change record of what was requested and applied",
      "Studio quality-control review before delivery",
    ],
    exclusions: [
      "Pixel-perfect or exact-layout matching of the original file",
      "Source-file editing, Canva-file editing, or editable-layer restoration",
      "New concept or campaign direction",
      "Complete redesign or structural rebuild beyond recreation needed for your changes",
    ...
    clientResponsibilities: [
      "A clear file or durable reference for the existing promotional item",
      "Exact replacement dates, prices, contact information, wording, or one image you supply",
      "Acknowledgment that fulfillment is reference-guided recreation with limits",
