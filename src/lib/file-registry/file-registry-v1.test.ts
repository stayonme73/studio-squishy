...
describe("File Registry + Shared Drive Reference Layer V1", () => {
  ...
  it("final delivery receives only released client-visible final references", () => {
    ...
    const readyJob = job({
      ...
      internalQaReviewAuthorization: {
        status: "ELIGIBLE_FOR_REVIEW",
        decisionId: "re-file-reg",
        packageId: "PRODUCTION-ASSURANCE-QA-BEFORE-REVIEW-1",
        skuId: "sm-001",
        qaRecordIds: ["qa-sm-001"],
        workVersionId: "work:file-reg",
        contentSha256s: ["sha256:file-reg"],
        artifactIds: ["artifact:file-reg"],
        authorizedAt: NOW,
      },
      customerApprovedArtifactAuthorization: {
        status: "CUSTOMER_APPROVED",
        decisionId: "caa-file-reg",
        schemaVersion: 1,
      ...
      clientDeliveryFiles: [
        {
          ...
          contentSha256: "sha256:file-reg",
          artifactId: "artifact:file-reg",
          approvedWorkVersionId: "work:file-reg",
          approvedAuthorizationDecisionId: "caa-file-reg",
          addedAt: NOW,
          addedBy: ownerActor,
        },
        {
