  ...
  "rtu-promotion-graphics": [
    {
      ...
      fields: [
        ...
        { label: "Graphic 1 — intended use", fieldId: "graphicA_authorizedPurpose" },
        { label: "Graphic 1 — agreed format", fieldId: "graphicA_agreedPlate" },
        { label: "Graphic 2 — intended use", fieldId: "graphicB_authorizedPurpose" },
        { label: "Graphic 2 — agreed format", fieldId: "graphicB_agreedPlate" },
        { label: "Materials", fieldId: "materials" },
        { label: "Disclosures (client-supplied)", fieldId: "disclaimers" },
      ],
    },
