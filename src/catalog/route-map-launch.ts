...
export const ROUTE_MAP_LAUNCH_SERVICES: readonly StudioServiceEntry[] = [
  ...
  routeMapLaunchService({
    ...
    productionLane: "quick_turn",
    purpose:
      "Basic setup for one Facebook, Instagram, or TikTok profile you already control — profile details and brand visuals aligned to your business.",
    deliverables: [
      "Profile image and cover/header where applicable",
      "Bio, about section, links, and contact details",
      "One defined setup direction aligned to your brand",
    ...
    revisionRule: ROUTE_MAP_REVISION_TEMPLATE,
    clientResponsibilities: [
      "Secure admin invitation access for the account you control — no passwords or casual login sharing",
  ...
  routeMapLaunchService({
    ...
    deliverables: [
      ...
      "Refreshes the bio, business information, and profile links",
      "Places, crops, or resizes customer-supplied profile and banner images",
      "Aligns the profile with the customer's current offer or branding",
      "One revision round included",
    ],
    exclusions: [
      "New account setup",
      ...
      "Custom logo, banner, or profile-image design — profile and banner treatment is placement, cropping, or resizing of customer-supplied assets only",
    ...
    revisionRule: ROUTE_MAP_REVISION_TEMPLATE,
    clientResponsibilities: [
      "Secure admin invitation access for the existing profile you control — no passwords or casual login sharing",
