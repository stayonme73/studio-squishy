...
export const CATALOG_V2_BATCH1_READY_TO_USE: readonly CatalogV2ServiceEntry[] = [
  ...
  batch1Base({
    ...
    intakeTemplateFieldsTbd: [
      ...
      "Logo, photos, colors, or brand materials",
      "Graphic 1 — intended use (Print, Social, Email, In-store, or Other)",
      "Graphic 1 — agreed format (Square 1024×1024, Portrait 1024×1536, or Landscape 1536×1024)",
      "Graphic 2 — intended use (Print, Social, Email, In-store, or Other)",
      "Graphic 2 — agreed format (Square 1024×1024, Portrait 1024×1536, or Landscape 1536×1024)",
