...
/** Studio payment — full three-panel order page. */
export default function PaymentCheckoutScene({ packageId, fromPrototype }: Props) {
  ...
  return (
    <div className="utility-page" aria-label="Payment">
      <UtilityPageHeader
