...
export const studioGuideV1Packages: readonly StudioGuideV1Package[] = [
  {
    ...
    timeline:
      "First concepts target after production starts and required materials are received",
    revisions: "1 Revision Round Included",
    refundPolicy: [
      "A refund may be approved before production starts on that job.",
      "No refunds after campaign development starts.",
    ],
    selectCta: "START WITH SPARK",
    marginNotes: [
      "Timeline after production starts",
      "1 revision included",
      "Refund may be approved before production starts",
  ...
  },
  {
    ...
    revisions: "1 Revision Round Included",
    refundPolicy: [
      "A refund may be approved before monthly production starts.",
    ...
    marginNotes: [
      "Timeline after production starts",
      "1 revision included",
      "Refund may be approved before monthly production starts",
