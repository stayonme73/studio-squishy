...
export const customerJourneyV1 = {
  steps: [
    ...
    },
    {
      order: 2,
      id: "studio-guide",
      name: "Studio Conversation Room",
      formerName: "Studio Guide",
      route: "/studio-conversation-room",
      routeAliases: ["/route-map", "/studio-guide-prototype", "/studio-guide"] as const,
    },
    {
      order: 3,
      id: "build-your-project",
      name: "Build Your Project",
      route: "/studio-conversation-room",
      routeAliases: ["/project-builder"] as const,
    },
    {
      order: 4,
      id: "secure-checkout",
      ...
      route: legacyRouteQuarantineV1.activeCheckout,
      routeAliases: ["/checkout", "/payment"] as const,
    },
    {
      order: 5,
      ...
      route: legacyRouteQuarantineV1.activeIntake,
      routeAliases: ["/route-map", "/project-discovery", "/business_discovery_studio"] as const,
    },
    {
      order: 6,
      id: "studio-board",
