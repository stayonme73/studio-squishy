...
export const ownerQa = {
  ...
  /** Guide → Secure Checkout → Intake → Studio Board — one click each. */
  journeyPresets: [
    {
      id: "fresh-guide",
    ...
    {
      id: "board-onboarding",
      label: `${customerJourneyStepName("studio-board")} — onboarding done`,
    ...
    {
      id: "board-building",
      label: `${customerJourneyStepName("studio-board")} — building concepts`,
      href: studioBoard.routes.studioBoard,
