...
export const ownerConsole = {
  ...
  refundDecision: {
    ...
    refundReasonLabel: "Owner refund reason (approve)",
    refundReasonPlaceholder: "Why you approved this refund — required for approve.",
    snapshotLabels: {
      clientReason: "Client refund reason",
      requestedOutcome: "Requested outcome",
      policyStatus: "Policy status",
      productionStatus: "Production status",
      conceptsOrFiles: "Concepts / files received",
      timelineFacts: "Timeline facts",
      missingEvidence: "Missing evidence",
      recommendedNextAction: "Recommended next action",
      supportingDetails: "Supporting details",
      requestChannel: "Request channel",
    },
    productionStartedYes: "Yes — production has started",
    productionStartedNo: "No — production has not started",
