...
| 4 | Full business rehearsal | **Current.** Room 4A CLOSED at `9f9ac7c`. Room 4B **CLOSED** at `8c919e0` (classifications frozen). Room 4C Multi-Service Client Gauntlet — **CLOSED WITH EXPLICIT LIMITS** at `969b68d`. Room 4 remains open. Do not start Room 5. |
