...
| 4 | Full business rehearsal | **Current.** Room 4A CLOSED at `9f9ac7c`. Room 4B **CLOSED** 2026-08-19 (classifications frozen). Next: Room 4C Multi-Service Client Gauntlet — **NAMED NOT STARTED** (do not start tonight). Do not start Room 5. |
