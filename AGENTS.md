...
- Route Map main screen — desk hero + Choose Your Route panel + How It Works strip at `/route-map` (`docs/route-map-main-screen-v1-locked.md`) — layout, art placement, panel position, and screen copy frozen; do not modify without Tagia approval
