...
| 4 | Full business rehearsal | **Current.** Room 4A CLOSED at `9f9ac7c`. Room 4B **CLOSED** at `8c919e0` (classifications frozen). Room 4C Multi-Service Client Gauntlet — **CLOSED WITH EXPLICIT LIMITS** at `92f47e2`. Pre-Launch Master Closeout Register — **ACTIVE_REGISTER** (not execution). Room 4 remains open. Do not start Room 5. |
